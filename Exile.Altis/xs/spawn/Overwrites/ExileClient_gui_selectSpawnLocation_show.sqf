...
[
	"Connect to the xstreme gaming discord at COMING SOON!",
	"Server news, comp claims and more join the community COMING SOON!",
...
//	"Any vehicle left inside the black safezone circle will be deleted at restart",
	...
	"Press 6 to Bring up your XM8 Tablet!"
];
